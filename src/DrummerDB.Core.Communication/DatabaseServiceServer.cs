...
namespace Drummersoft.DrummerDB.Core.Communication
{
    internal class DatabaseServiceServer
    {
        ...
        public static void Run(string[] args, string[] url, DatabaseServiceHandler processor, PortSettings portSettings)
        {
        ...
        public static Task RunAsync(string[] args, DatabaseServiceHandler processor, PortSettings portSettings)
        {
        ...
        private static IHostBuilder CreateHostBuilder(string[] args, DatabaseServiceHandler processor, PortSettings portSettings)
        {
