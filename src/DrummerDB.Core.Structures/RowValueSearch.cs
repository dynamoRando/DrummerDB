...
{
    internal struct RowValueSearch
    {
        ...
        #region Constructors
        public RowValueSearch(ColumnSchemaStruct column, string value, bool padIfNeeded = false)
        {
            Column = column;
        ...
        public RowValueSearch(ColumnSchemaStruct column, ReadOnlySpan<byte> value, bool padIfNeeded = false)
        {
            Column = column;
            _value = value.ToArray();
        }

        public RowValueSearch(ColumnSchemaStruct column, byte[] value, bool padIfNeeded = false)
        {
            Column = column;
            _value = value;
        }
