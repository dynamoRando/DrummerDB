...
// see https://github.com/antlr/antlr4/blob/master/doc/case-insensitive-lexing.md#custom-character-streams-approach
...
namespace Drummersoft.DrummerDB.Core.QueryTransaction.SQLParsing
{
    ...
    public class CaseChangingCharStream : ICharStream
    {
        ...
        [return: a.NotNull]
        public string GetText(a.Interval interval)
        {
